 ...
 */
module.exports = class EmailGenerator extends Generator {
    ...
    _generateProjectBackend() {
        this.log('Creating Email backend ...');
        ...
        let from = this.templatePath('email/src/main/java/app/');
        ...
        this.log('Email successfully created.');
    }
