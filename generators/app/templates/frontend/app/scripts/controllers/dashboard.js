...
app.controller('DashboardController', ['$q', '$scope', '$rootScope', '$filter', '$timeout', 'DashboardService', 'ProdutoService', 'AlertService',
    function ($q, $scope, $rootScope, $filter, $timeout, DashboardService, ProdutoService, AlertService) {
        ...
        $scope.carregarTimeline = function () {
            $scope.versoes = null;
            DashboardService.getProdutoComVersoesEFases($scope.produto).then(function (data) {
                $scope.versoes = [];
