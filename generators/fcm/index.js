 ...
 */
module.exports = class FCMGenerator extends Generator {
    ...
    _generateProjectBackend() {
        ...
        let from = this.templatePath('fcm/src/main/java/app/');
        ...
        this.log('FCM successfully created.');
    }
